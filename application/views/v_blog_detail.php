...
<html class="no-js">
	...
	<meta name="author" content="Rony Logam" />
    ...
    <meta property="og:site_name" content="RonyLogam.com" />
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li class="cta"><a href="<?php echo base_url().'portfolio'?>">Kembali</a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'assets/images/cyberpunk.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2><strong>Enjoy Our Blog</strong></h2>
